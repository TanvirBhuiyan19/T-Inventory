          ...
          <div class="card-body">
	              ...
	              <div class="form-row">
	               <div class="col-md-6 col-sm-12">
	                <div class="form-label-group">
	                  <label for="firstName">Full Name</label><span class="text-danger">*</span>
	               ...
	               <div class="col-md-6 col-sm-12">
	                <div class="form-label-group">
	                  <label for="lastName">Email Address</label><span class="text-danger">*</span>
	          ...
	          <div class="form-group">
	              <div class="form-row">
	               <div class="col-md-6 col-sm-12">
	                <div class="form-label-group">
	                  <label for="firstName">Address</label><span class="text-danger">*</span>
	               ...
	               <div class="col-md-6 col-sm-12">
	                <div class="form-label-group">
	                  <label for="lastName">Salary</label><span class="text-danger">*</span>
	          ...
	          <div class="form-group">
	              <div class="form-row">
	               <div class="col-md-4 col-sm-12">
	                <div class="form-label-group">
	                  <label for="firstName">Joining Date</label><span class="text-danger">*</span>
	              ...
	              <div class="form-row">
	               ...
	               <div class="col-md-6 col-sm-12">
	                ...
	                <div class="col-md-3 col-sm-6">
	                	...
	                	<img :src="'/backend/uploads/employee/' + form.oldPhoto" style="height: 70px; width: auto; border: 2px solid #D1D3E2;" >
	                </div>
	             </div>
	          </div>
