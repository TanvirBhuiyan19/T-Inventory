...
<h3 align="center">Today's Report ({{ date("d F Y h:i A") }})</h3><hr style="align-content: center; width: 50%; margin-top:-20px;">
        
  <h2 align="center" style="color: darkorange">Today Expenses</h2>
        <table width="100%">
                ...
                @if( count($todayExpenses) == 0)
                    <tr class="font">
                        <td align="center" style="border-bottom: 1px solid;padding-bottom: 5px;" colspan="2">
                            <h1>No Expense found Today!</h1><br/><br/>
                        </td>
                    </tr>
                @else
                    @foreach ($todayExpenses as $item)
                    <tr class="font">
        ...
        <table width="100%" style=" padding:0 10px 0 10px;">
          <tr>
              ...
              <td align="right" >
                  <h2><span>Today Sell : </span> {{$todaySell}} Tk</h2>
                  <h2><span>Today Profit : </span> {{$todayErnings}} Tk</h2>
                  <h2><span>Today Expense : </span> {{$todayExpenseTotal}} Tk</h2>
